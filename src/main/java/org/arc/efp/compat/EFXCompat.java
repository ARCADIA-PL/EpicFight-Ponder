...
import org.arc.efp.client.ponder.EFPWeaponScenes;
...
public class EFXCompat {
    ...
    public static void showcaseHeartPiercer_EFX(SceneBuilder baseScene, SceneBuildingUtil util) {
        EpicFightSceneBuilder builder = new EpicFightSceneBuilder(baseScene);
        EpicFightSceneBuilder.EpicFightWorldInstructions world = builder.world();
        ...
        world.playAnimation(attacker, AnimationsX.HEARTPIERCER, 0.0F);

        builder.idle(30);
        builder.markAsFinished();
    }

    public static void showcaseSharpStab_EFX(SceneBuilder baseScene, SceneBuildingUtil util) {
        EpicFightSceneBuilder builder = new EpicFightSceneBuilder(baseScene);
        EpicFightSceneBuilder.EpicFightWorldInstructions world = builder.world();
        ...
        world.playAnimation(attacker, AnimationsX.SHARP_STAB, 0.0F);

        builder.idle(30);
        builder.markAsFinished();
    }

    public static void showcaseSteelWhirlWind_EFX(SceneBuilder baseScene, SceneBuildingUtil util) {
        EpicFightSceneBuilder builder = new EpicFightSceneBuilder(baseScene);
        EpicFightSceneBuilder.EpicFightWorldInstructions world = builder.world();
        ...
        world.playAnimation(attacker, AnimationsX.STEEL_WHIRLWIND_CHARGING, 0.0F);
        EFPSceneUtils.showText(builder, util, "epic_fight_ponder.ponder.steel_whirlwind.text_1", 30, 5, 1, 5);
        builder.idle(20);
        world.playAnimation(attacker, AnimationsX.STEEL_WHIRLWIND, 0.0F);
