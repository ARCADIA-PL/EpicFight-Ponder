package org.arc.efp.client.render.patched;
...
import org.arc.efp.client.render.DummyVictimPlayerRenderer;
import org.arc.efp.entity.DummyVictimPlayerEntity;
...
public class PDummyVictimPlayerRenderer extends PHumanoidRenderer<DummyVictimPlayerEntity, HumanoidMobPatch<DummyVictimPlayerEntity>, PlayerModel<DummyVictimPlayerEntity>, DummyVictimPlayerRenderer, HumanoidMesh> {

    public PDummyVictimPlayerRenderer(EntityRendererProvider.Context context, EntityType<?> entityType) {
    ...
    @Override
    protected void prepareModel(HumanoidMesh mesh, DummyVictimPlayerEntity entity, HumanoidMobPatch<DummyVictimPlayerEntity> dummyPlayerEntityHumanoidMobPatch, DummyVictimPlayerRenderer renderer) {
        super.prepareModel(mesh, entity, dummyPlayerEntityHumanoidMobPatch, renderer);

        PlayerModel<DummyVictimPlayerEntity> model = renderer.getModel();
    ...
    @Override
    public AssetAccessor<HumanoidMesh> getMeshProvider(HumanoidMobPatch<DummyVictimPlayerEntity> dummyPlayerEntityHumanoidMobPatch) {
